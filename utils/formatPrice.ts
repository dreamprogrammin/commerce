...
/**
 * Цена со знаком тенге для текста: «18 890 ₸» не разрывается целиком.
 *
 * Внутри числа неразрывный пробел ставит `formatPrice`, а между числом и
 * знаком обычный пробел оставался, и в абзаце ₸ уезжал на следующую строку
 * один: «…от 15 000 | ₸ — бесплатно» в ответе про самовывоз на ширине 390
 * (25 сентября 2026).
 */
