        ...
        output: {
          ...
          manualChunks(id) {
            if (id.includes('node_modules')) {
               ...
               *    вовсе, все 134.2 КБ остались. Примитивы достижимы из
               *    жадно рисуемых компонентов, и Rollup честно кладёт их в
               *    входной чанк. Чтобы сдвинуть их, надо менять не сборку,
               *    а то, откуда они достижимы, — это отдельная работа с
               *    риском для интерфейса;
