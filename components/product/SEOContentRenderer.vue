...
<template>
  <!--
    Компонент намеренно без собственной карточки и без сворачивания:
    на карточке товара он живёт внутри блока «О товаре», который сам рисует
    карточку и управляет сворачиванием описания (градиентная маска + кнопка).
  -->
