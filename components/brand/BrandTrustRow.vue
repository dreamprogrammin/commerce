...
const ITEMS: TrustItem[] = [
  ...
  {
    icon: 'lucide:truck',
    // Срок — с `/terms`. В макете стояло «1–2 дня», это быстрее условий.
  ...
  },
  {
    ...
    // Стояло «Если конструктор не подошёл» — текст пришёл с макета LEGO, а
    // полоса стоит на всех брендах: у кукол и игровых наборов он странный.
    note: 'Если товар не подошёл',
