...
<template>
    <section class="container py-8 md:py-16">
      <div class="max-w-4xl mx-auto">
        <Card class="bg-gradient-to-br from-primary/10 via-background to-background dark:from-primary/20 dark:via-background text-center shadow-lg border-2 border-primary/20">
          <CardHeader class="items-center">
            <div class="p-4 bg-background rounded-full mb-4 ring-2 ring-yellow-400/50">
              <Gift class="w-10 h-10 text-primary" />
            </div>
            <CardTitle class="text-2xl md:text-3xl">Наша Бонусная Программа</CardTitle>
            <CardDescription class="text-base">Копите и тратьте бонусы на свои мечты!</CardDescription>
          </CardHeader>
  
          <CardContent class="text-lg space-y-4">
            <p>
              Получайте <span class="font-bold">кэшбек</span> с каждой покупки и используйте его для оплаты следующих заказов.
            </p>
            ...
            <div v-if="user" class="mt-6 pt-6 border-t border-dashed">
              ...
              <div v-else-if="displayProfile">
                <p class="text-muted-foreground">На вашем счету:</p>
