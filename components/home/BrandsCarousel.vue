...
<template>
  <section v-if="brands && brands.length > 0" class="py-8 md:py-12 bg-linear-to-b from-background to-muted/10">
    ...
    <div class="relative group/scroll">
      ...
      <button
        v-if="canScrollLeft"
        class="hidden md:flex absolute left-1 top-1/2 -translate-y-1/2 z-10 w-10 h-10 rounded-full bg-background/90 shadow-md border border-border/50 items-center justify-center hover:bg-background transition-all opacity-0 group-hover/scroll:opacity-100"
        @click="scrollBy(-1)"
      >
      ...
      <button
        v-if="canScrollRight"
        class="hidden md:flex absolute right-1 top-1/2 -translate-y-1/2 z-10 w-10 h-10 rounded-full bg-background/90 shadow-md border border-border/50 items-center justify-center hover:bg-background transition-all opacity-0 group-hover/scroll:opacity-100"
        @click="scrollBy(1)"
      >
      ...
      <div
        ref="scrollContainer"
        class="overflow-x-auto hide-scrollbar cursor-grab active:cursor-grabbing"
