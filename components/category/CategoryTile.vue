...
@layer components {
  ...
  /* Размеры подобраны глазами, а не из прототипа: там картинки были
     обрезаны по краю, а в боевой базе они с большими полями внутри файла,
     и при прежних 76/62% предмет выглядел мелким в углу плитки.

     Расти дальше мешает заголовок: он лежит в левом верхнем углу и при
     большей высоте начинает наезжать на картинку. Перекрытия нет — у
     заголовка свой z-index, — но визуально становится тесно. */
  .ct--corner .ct__media {
    position: absolute;
    right: 2px;
    bottom: 2px;
