 ...
 *  • Цвет строки `meta` — `var(--primary)` вместо `var(--blue-700)`
 *    прототипа. Токена `--blue-700` в приложении нет, а `--primary` — это уже
 *    притемнённый под WCAG фирменный синий (assets/css/tailwind.css).
