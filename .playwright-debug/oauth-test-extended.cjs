...
(async () => {
  ...
  try {
    ...
    if (currentUrl.includes('/profile')) {
      ...
      if (hasTitle) console.log('✅ Заголовок "Настройки профиля" отображается');
      if (hasBonuses) console.log('✅ Секция "Мои бонусы" отображается');
      if (hasProfile) console.log('✅ Секция "Мой профиль" отображается');
