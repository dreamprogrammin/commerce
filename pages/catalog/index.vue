 ...
 * то есть хвост срезался, а декоративные символы съедали место. Правило то
 * же, что у категорий (см. `composeCategoryMeta`) — факты без украшений.
 */
const metaDescription = 'Каталог детских игрушек Ухтышка: конструкторы, куклы, машинки, развивающие игры и творчество. Доставка по Казахстану, самовывоз в Алматы, бонусы за покупку.'
