...
useHead({
  // «Ухтышка», а не «uhti.kz» — см. пояснение в pages/index.vue
  title: 'Политика конфиденциальности — Ухтышка',
  meta: [
    { name: 'description', content: 'Политика конфиденциальности интернет-магазина Ухтышка. Сбор, обработка и защита персональных данных.' },
  ],
})
</script>
