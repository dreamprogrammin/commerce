...
useHead({
  // «Ухтышка», а не «uhti.kz»: латинское написание отдано главной, иначе
  // правовые страницы перебивали её по брендовому запросу — см. pages/index.vue
  title: 'Условия использования — Ухтышка',
  meta: [
    {
      name: 'description',
      content:
        'Условия использования интернет-магазина Ухтышка. Правила покупки, доставки и возврата товаров.',
    },
    ...
    <div class="prose prose-sm max-w-none space-y-6 text-foreground">
      ...
      <section>
        ...
        <ul class="list-disc space-y-1 pl-6">
          ...
          <li>Переводом или по QR через Kaspi — после подтверждения заказа</li>
        </ul>
      </section>
      ...
      <!--
        ...
        `id` нужен ссылкам «Правила» из карточки бонусной программы: отдельной
        страницы правил у магазина нет, условия опубликованы здесь.
        `scroll-mt` — чтобы липкая шапка не накрыла заголовок при переходе
        по якорю.
      -->
      <section id="bonusy" class="scroll-mt-24">
        <h2 class="text-xl font-semibold">
          7. Бонусная программа
        </h2>
        <p>
