...
/*
 * Адрес и часы магазина. ЗЕРКАЛО `constants/shop.ts` — эдж-функции живут в
 * Deno и файлы фронта не импортируют. Меняете там — поменяйте здесь, иначе
 * чат с покупателем и сайт разойдутся, как это уже было: сайт обещал
 * «9:00–21:00», а бот говорил «10:00–20:00».
 *
 * Номер дома и настоящие часы названы владельцем 21 сентября 2026.
 */
export const PICKUP_POINT = {
  address: 'г. Алматы, мкр. Шапагат, ул. Амангельды, 100',
