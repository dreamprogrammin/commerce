-- ============================================================================
-- ФИКС: Восстанавливаем параметр p_numeric_attributes в get_filtered_products
-- ============================================================================
-- Предыдущая миграция (20260212034613) пересоздала функцию без p_numeric_attributes.
-- Эта миграция восстанавливает полную сигнатуру с 15 параметрами.
-- ============================================================================
...
BEGIN
    ...
    WITH filtered_products AS (
        ...
        WHERE
            ...
            -- 9. Фильтр по числовым атрибутам
            AND (
...
'Возвращает отфильтрованный список товаров с изображениями. Фильтрация и сортировка по цене учитывают discount_percentage. Поддерживает числовые атрибуты.';
