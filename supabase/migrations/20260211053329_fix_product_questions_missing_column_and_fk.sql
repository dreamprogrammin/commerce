-- Добавляем недостающую колонку is_auto_generated
ALTER TABLE public.product_questions
  ADD COLUMN IF NOT EXISTS is_auto_generated BOOLEAN DEFAULT false;

-- user_id nullable для автогенерированных вопросов
ALTER TABLE public.product_questions
  ALTER COLUMN user_id DROP NOT NULL;

-- Пересоздаём FK к profiles
ALTER TABLE public.product_questions
...
-- Обновляем функцию генерации вопросов
...
-- Обновляем функцию массовой генерации
