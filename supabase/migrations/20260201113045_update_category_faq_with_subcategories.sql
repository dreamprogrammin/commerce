-- ====================================
-- ОБНОВЛЕНИЕ FAQ: ДОБАВЛЕНИЕ ПОДКАТЕГОРИЙ В ОТВЕТ
-- ====================================
...
DECLARE
  ...
  v_top_brands TEXT;
  v_subcategories TEXT; -- 🆕 Подкатегории для ответа
  v_result JSON;
BEGIN
  ...
  -- 🆕 Получаем подкатегории 2 и 3 уровня
  ...
  LIMIT 10; -- Ограничиваем до 10 подкатегорий для читаемости
...
'Генерирует FAQ для категории с упоминанием подкатегорий, брендов и линеек, без вопросов о доставке';
