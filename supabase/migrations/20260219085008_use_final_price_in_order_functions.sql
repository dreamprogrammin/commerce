-- ============================================================================
-- Обновление функций заказов: используем generated column final_price
-- ============================================================================
-- Заменяем ручное вычисление price * (100 - discount) / 100 на final_price
-- Единый источник правды для расчёта цены со скидкой
-- ============================================================================

-- 1. create_guest_checkout
...
'Гостевой заказ. Использует generated column final_price.';
...
'Заказ для авторизованного пользователя. Использует generated column final_price.';
