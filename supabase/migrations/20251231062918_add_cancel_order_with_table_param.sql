-- =====================================================================================
-- Обновление функции cancel_order с опциональным параметром таблицы
-- =====================================================================================
-- Добавляем параметр p_table_name с DEFAULT 'orders' для обратной совместимости
-- Это позволяет вызывать функцию как с одним, так и с двумя параметрами
-- =====================================================================================

-- Удаляем старую функцию
DROP FUNCTION IF EXISTS public.cancel_order(UUID);

-- Создаем новую функцию с опциональным параметром
...
Откатывает товары на склад и бонусные операции для зарегистрированных пользователей.';
