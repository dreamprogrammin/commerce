...
-- === ЧАСТЬ 1: УДАЛЯЕМ АВТОМАТИЧЕСКОЕ СОЗДАНИЕ ПРОФИЛЕЙ ===

-- Удаляем триггер автосоздания профилей
DROP TRIGGER IF EXISTS on_auth_user_created ON auth.users;
DROP FUNCTION IF EXISTS public.handle_new_user();

-- Удаляем функцию приветственного бонуса при создании профиля
...
-- === ЧАСТЬ 2: ЛОГИКА ПРИВЕТСТВЕННОГО БОНУСА ПРИ ПЕРВОЙ ПОКУПКЕ ===
