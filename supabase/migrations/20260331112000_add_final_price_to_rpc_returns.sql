-- ================================================================================
-- МИГРАЦИЯ: Добавление final_price в get_filtered_products (2026-03-31)
-- ================================================================================
-- Проблема: RPC функция get_filtered_products не возвращает final_price,
-- из-за чего фронтенд вынужден рассчитывать цены самостоятельно.
-- Это создает расхождение между базой (15 290 ₸) и фронтом (15 302 ₸).
--
-- Решение: Добавляем final_price в RETURNS TABLE и SELECT
-- ================================================================================

-- Находим и удаляем все версии функции
DO $$
DECLARE
    r RECORD;
BEGIN
...
-- Пересоздаем функцию с final_price
...
'Каталог товаров. Возвращает final_price с психологическим округлением из базы данных.';
