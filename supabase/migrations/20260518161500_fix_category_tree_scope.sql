-- ================================================================================
-- FIX: Исправление области видимости CTE category_tree
-- ================================================================================
...
DECLARE
  ...
  v_category_ids UUID[];
BEGIN
  -- Собираем все ID категорий (текущая + подкатегории) в массив
...
'Генерирует уникальные FAQ для категории с учётом товаров из всех подкатегорий (рекурсивно через массив ID).';
